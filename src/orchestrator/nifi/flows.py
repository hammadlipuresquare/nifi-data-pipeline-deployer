...
class FlowManager(LoggerMixin):
    ...
    def smart_import_flow_from_registry(self, parent_pg_id: str, flow_info: FlowVersionInfo,
        ...
        self.logger.info(f"Importing flow '{flow_info.flow_name}' at position ({smart_position['x']}, {smart_position['y']})")
    ...
    def _find_flows_with_same_version_control(self, parent_pg_id: str, flow_info: FlowVersionInfo) -> List[Dict[str, Any]]:
